# Solar System Explorer — CSS Only ☀️🪐
...
## ✨ Features
- Planets orbiting the sun — 100% CSS animation
- **No JavaScript** anywhere
- Written in HAML (markup) + SCSS (styles)

## 🛠️ Built With
- HAML
- SCSS / CSS3 keyframe animation
...
<sub>Built by <a href="https://github.com/bipin-vishwakarma">Bipin Vishwakarma</a></sub>
